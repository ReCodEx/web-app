  ...
  render() {
    const {
      ...
      messages: {
        ...
        submitting: submittingMsg = <FormattedMessage id='app.editExerciseForm.submitting' defaultMessage='Submitting...' />,
        validating: validatingMsg = <FormattedMessage id='app.submitButton.validating' defaultMessage='Validating...' />,
        invalid: invalidMsg = <FormattedMessage id='app.submitButton.invalid' defaultMessage='Some input is invalid' />
      }
    } = this.props;
