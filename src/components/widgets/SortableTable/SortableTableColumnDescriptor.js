...
class SortableTableColumnDescriptor {
  ...
  getHeaderSuffixStyle = () =>
    this.headerSuffixStyle || this.headerStyle || this.style;
  getHeaderSuffixClassName = () =>
    this.headerSuffixClassName || this.headerClassName || this.className;
}
