  ...
  return (
    <FormBox
      ...
      <Field
        ...
        onOff
        label={
          <FormattedMessage id="app.editUserUIData.openedSidebar" defaultMessage="Sidebar is unfolded by default" />
        }
      />
      ...
      <Field
        ...
        onOff
        label={
          <FormattedMessage id="app.editUserUIData.vimMode" defaultMessage="Use Vim mode in source code editors" />
        }
      />
