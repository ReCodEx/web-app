...
const prepareFieldsIndices = (fields, tabComparator, currentLocale) => {
...
const TabbedArrayField = ({
  ...
  const [indices, defaultIndex] = prepareFieldsIndices(fields, tabComparator, locale);
