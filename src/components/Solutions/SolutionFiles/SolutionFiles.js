                ...
                <Table hover className="card-table">
                  <tbody>
                    {canDisplayFiles ? (
                      ...
                      <tr>
                        <td colSpan={5} className="text-center text-body-secondary small p-4">
                          <WarningIcon gapRight />
                          <FormattedMessage
                            id="app.solutionFiles.cannotDisplay"
                            defaultMessage="Cannot display the list since there are too many files..."
                          />{' '}
                  ...
                  <tfoot>
                    <tr>
                      <td colSpan={2} />
                      <td className="small text-body-secondary w-100 text-end">
                        <em>
