...
export const additionalActionTypes = {
  VALIDATE_REGISTRATION_DATA: 'recovid/users/VALIDATE_REGISTRATION_DATA',
  VALIDATE_REGISTRATION_DATA_PENDING: 'recovid/users/VALIDATE_REGISTRATION_DATA_PENDING',
  VALIDATE_REGISTRATION_DATA_FULFILLED: 'recovid/users/VALIDATE_REGISTRATION_DATA_FULFILLED',
  VALIDATE_REGISTRATION_DATA_REJECTED: 'recovid/users/VALIDATE_REGISTRATION_DATA_REJECTED',
  CREATE_LOCAL_LOGIN: 'recovid/users/CREATE_LOCAL_LOGIN',
  CREATE_LOCAL_LOGIN_PENDING: 'recovid/users/CREATE_LOCAL_LOGIN_PENDING',
  CREATE_LOCAL_LOGIN_FULFILLED: 'recovid/users/CREATE_LOCAL_LOGIN_FULFILLED',
  CREATE_LOCAL_LOGIN_REJECTED: 'recovid/users/CREATE_LOCAL_LOGIN_REJECTED',
  SET_ROLE: 'recovid/users/SET_ROLE',
  SET_ROLE_PENDING: 'recovid/users/SET_ROLE_PENDING',
  SET_ROLE_FULFILLED: 'recovid/users/SET_ROLE_FULFILLED',
  SET_ROLE_REJECTED: 'recovid/users/SET_ROLE_REJECTED',
  SET_IS_ALLOWED: 'recovid/users/SET_IS_ALLOWED',
  SET_IS_ALLOWED_PENDING: 'recovid/users/SET_IS_ALLOWED_PENDING',
  SET_IS_ALLOWED_FULFILLED: 'recovid/users/SET_IS_ALLOWED_FULFILLED',
  SET_IS_ALLOWED_REJECTED: 'recovid/users/SET_IS_ALLOWED_REJECTED',
};
