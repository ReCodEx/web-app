...
export const additionalActionTypes = {
  LOAD_USERS_GROUPS: 'recovid/groups/LOAD_USERS_GROUPS',
  LOAD_USERS_GROUPS_PENDING: 'recovid/groups/LOAD_USERS_GROUPS_PENDING',
  LOAD_USERS_GROUPS_FULFILLED: 'recovid/groups/LOAD_USERS_GROUPS_FULFILLED',
  LOAD_USERS_GROUPS_REJECTED: 'recovid/groups/LOAD_USERS_GROUPS_REJECTED',
  JOIN_GROUP: 'recovid/groups/JOIN_GROUP',
  JOIN_GROUP_PENDING: 'recovid/groups/JOIN_GROUP_PENDING',
  JOIN_GROUP_FULFILLED: 'recovid/groups/JOIN_GROUP_FULFILLED',
  JOIN_GROUP_REJECTED: 'recovid/groups/JOIN_GROUP_REJECTED',
  LEAVE_GROUP: 'recovid/groups/LEAVE_GROUP',
  LEAVE_GROUP_PENDING: 'recovid/groups/LEAVE_GROUP_PENDING',
  LEAVE_GROUP_FULFILLED: 'recovid/groups/LEAVE_GROUP_FULFILLED',
  LEAVE_GROUP_REJECTED: 'recovid/groups/LEAVE_GROUP_REJECTED',
  MAKE_SUPERVISOR: 'recovid/groups/MAKE_SUPERVISOR',
  MAKE_SUPERVISOR_PENDING: 'recovid/groups/MAKE_SUPERVISOR_PENDING',
  MAKE_SUPERVISOR_FULFILLED: 'recovid/groups/MAKE_SUPERVISOR_FULFILLED',
  MAKE_SUPERVISOR_REJECTED: 'recovid/groups/MAKE_SUPERVISOR_REJECTED',
  REMOVE_SUPERVISOR: 'recovid/groups/REMOVE_SUPERVISOR',
  REMOVE_SUPERVISOR_PENDING: 'recovid/groups/REMOVE_SUPERVISOR_PENDING',
  REMOVE_SUPERVISOR_FULFILLED: 'recovid/groups/REMOVE_SUPERVISOR_FULFILLED',
  REMOVE_SUPERVISOR_REJECTED: 'recovid/groups/REMOVE_SUPERVISOR_REJECTED',
  ADD_ADMIN: 'recovid/groups/ADD_ADMIN',
  ADD_ADMIN_PENDING: 'recovid/groups/ADD_ADMIN_PENDING',
  ADD_ADMIN_FULFILLED: 'recovid/groups/ADD_ADMIN_FULFILLED',
  ADD_ADMIN_REJECTED: 'recovid/groups/ADD_ADMIN_REJECTED',
  REMOVE_ADMIN: 'recovid/groups/REMOVE_ADMIN',
  REMOVE_ADMIN_PENDING: 'recovid/groups/REMOVE_ADMIN_PENDING',
  REMOVE_ADMIN_FULFILLED: 'recovid/groups/REMOVE_ADMIN_FULFILLED',
  REMOVE_ADMIN_REJECTED: 'recovid/groups/REMOVE_ADMIN_REJECTED',
  SET_ORGANIZATIONAL: 'recovid/groups/SET_ORGANIZATIONAL',
  SET_ORGANIZATIONAL_PENDING: 'recovid/groups/SET_ORGANIZATIONAL_PENDING',
  SET_ORGANIZATIONAL_FULFILLED: 'recovid/groups/SET_ORGANIZATIONAL_FULFILLED',
  SET_ORGANIZATIONAL_REJECTED: 'recovid/groups/SET_ORGANIZATIONAL_REJECTED',
  SET_ARCHIVED: 'recovid/groups/SET_ARCHIVED',
  SET_ARCHIVED_PENDING: 'recovid/groups/SET_ARCHIVED_PENDING',
  SET_ARCHIVED_FULFILLED: 'recovid/groups/SET_ARCHIVED_FULFILLED',
  SET_ARCHIVED_REJECTED: 'recovid/groups/SET_ARCHIVED_REJECTED',
  RELOCATE: 'recovid/groups/RELOCATE',
  RELOCATE_PENDING: 'recovid/groups/RELOCATE_PENDING',
  RELOCATE_FULFILLED: 'recovid/groups/RELOCATE_FULFILLED',
  RELOCATE_REJECTED: 'recovid/groups/RELOCATE_REJECTED',
};
