...
export const additionalActionTypes = {
  LOAD_USERS_SOLUTIONS: 'recovid/solutions/LOAD_USERS_SOLUTIONS',
  LOAD_USERS_SOLUTIONS_PENDING: 'recovid/solutions/LOAD_USERS_SOLUTIONS_PENDING',
  LOAD_USERS_SOLUTIONS_FULFILLED: 'recovid/solutions/LOAD_USERS_SOLUTIONS_FULFILLED',
  LOAD_USERS_SOLUTIONS_REJECTED: 'recovid/solutions/LOAD_USERS_SOLUTIONS_REJECTED',
  LOAD_ASSIGNMENT_SOLUTIONS: 'recovid/solutions/LOAD_ASSIGNMENT_SOLUTIONS',
  LOAD_ASSIGNMENT_SOLUTIONS_PENDING: 'recovid/solutions/LOAD_ASSIGNMENT_SOLUTIONS_PENDING',
  LOAD_ASSIGNMENT_SOLUTIONS_FULFILLED: 'recovid/solutions/LOAD_ASSIGNMENT_SOLUTIONS_FULFILLED',
  LOAD_ASSIGNMENT_SOLUTIONS_REJECTED: 'recovid/solutions/LOAD_ASSIGNMENT_SOLUTIONS_REJECTED',
  SET_NOTE: 'recovid/solutions/SET_NOTE',
  SET_NOTE_PENDING: 'recovid/solutions/SET_NOTE_PENDING',
  SET_NOTE_FULFILLED: 'recovid/solutions/SET_NOTE_FULFILLED',
  SET_NOTE_REJECTED: 'recovid/solutions/SET_NOTE_REJECTED',
  SET_BONUS_POINTS: 'recovid/solutions/SET_BONUS_POINTS',
  SET_BONUS_POINTS_PENDING: 'recovid/solutions/SET_BONUS_POINTS_PENDING',
  SET_BONUS_POINTS_FULFILLED: 'recovid/solutions/SET_BONUS_POINTS_FULFILLED',
  SET_BONUS_POINTS_REJECTED: 'recovid/solutions/SET_BONUS_POINTS_REJECTED',
  SET_FLAG: 'recovid/solutions/SET_FLAG',
  SET_FLAG_PENDING: 'recovid/solutions/SET_FLAG_PENDING',
  SET_FLAG_FULFILLED: 'recovid/solutions/SET_FLAG_FULFILLED',
  SET_FLAG_REJECTED: 'recovid/solutions/SET_FLAG_REJECTED',
  RESUBMIT_ALL: 'recovid/solutions/RESUBMIT_ALL',
  RESUBMIT_ALL_PENDING: 'recovid/solutions/RESUBMIT_ALL_PENDING',
  RESUBMIT_ALL_FULFILLED: 'recovid/solutions/RESUBMIT_ALL_FULFILLED',
  RESUBMIT_ALL_REJECTED: 'recovid/solutions/RESUBMIT_ALL_REJECTED',
  DOWNLOAD_RESULT_ARCHIVE: 'recovid/files/DOWNLOAD_RESULT_ARCHIVE',
};
