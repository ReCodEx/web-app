...
import { fetchManyEndpoint } from '../modules/sisTerms';
...
export const termSelector = termId =>
  createSelector(termsSelector, terms => terms.get(termId));

export const fetchManyStatus = createSelector(getTerms, state =>
