...
import { hasFailed, didInvalidate } from './status.js';
 ...
 */
export const defaultSelectorFactory = resourceName => state => state[resourceName];
 ...
 */
export const defaultNeedsRefetching = item => !item || hasFailed(item) || didInvalidate(item);
