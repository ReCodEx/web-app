...
import { groupsAssignmentsSelector, supervisorOfSelector, studentOfSelector } from '../../redux/selectors/groups';
      ...
      (dispatch, getState) =>
        dispatch(fetchUserIfNeeded(userId))
          .then(() => {
            ...
            return dispatch(fetchGroupsIfNeeded(...groups))
    ...
    return (
      <Page
        ...
        {user => (
                ...
                {(...groups) => (
                  <div>
                    <h2 className='page-heading'>
                      <FormattedMessage id='app.dashboard.studentOf' defaultMessage='Groups you are student of' />
                    </h2>
          ...
          {student && studentOfGroupsIds.length === 0 && (
            <Row>
              <Col sm={12}>
          ...
          {supervisor && supervisorOfGroupsIds.length === 0 && (
            <Row>
              <Col sm={12}>
                <div className='callout callout-success'>
                  <h4>
...
export default connect(
  (state) => {
    ...
    return {
      ...
      supervisorOfGroupsIds: supervisorOfGroupsIdsSelector(userId)(state).toArray(),
  ...
  (dispatch, { params }) => ({
    loadAsync: (loggedInUserId) => Dashboard.loadAsync(params, dispatch, loggedInUserId)
  })
)(Dashboard);
